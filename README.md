...
Коэффициент запаса на пиковое потребление относительно среднего для видеочата = 717 Гбит/с / 233.2 Гбит/с = 3.08  
Пиковый трафик для сообщений = средний трафик для сообщений * коэффициент запаса = 7.64 Гбит/с = 23.53 Гбит/с
...
Коэффициент запаса на пиковое потребление относительно среднего, рассчитанный ранее, равен 3,08  

#### Рассчитаем трафик:  
User: 1.6 RPS * 370 байт * 8 = 4.7 Кбит/сек  
Server: 3.5 RPS * 859 байт * 8 = 23 Кбит/сек  
Channel: 10.5 * 118 байт * 8 = 9.7 Кбит/сек  
Message: 11,976 * (1,822 + 270) * 8 = 191.1 Мбит/сек  
Attachment: 7.63 Гбит/с  
Call: 1,041 * 12 * 8 + 233.2 Гбит/с = 233.2 Гбит/с  

| Сервис               | RPS | Трафик | Бизнес-логика | CPU | CPU на пиковое потребление | RAM |
| ---------------------- | -------------------------: | -------------------------: | -------------------------: | -------------------------: | -------------------------: | -------------------------: |
| Auth/User| 1.6 | 4.7 Кбит/сек | Легкая | 1 | 1 | 0.1 Гб |
| Server | 3.5 | 23 Кбит/сек | Средняя | 1 | 1 | 0.1 Гб |
| Channel | 10.5 | 9.7 Кбит/сек | Лёгкая | 1 | 1 | 0.1 Гб |
| Message | 11,976 | 191.1 Мбит/сек | Средняя | 120 | 370 | 120 Гб |
| Attachment | 556.8 | 7.63 Гбит/с | Тяжёлая | 55 | 170 | 170 Гб |
| Call | 1,041 | 233.2 Гбит/с | Тяжёлая | 100 | 308 | 308 Гб |

### Нагрузка на БД
| Хранилище               | Объем | RPS |
| ---------------------- | -------------------------: | -------------------------: |
| PostgreSQL | 232.66 Гб | 16.7 |
| Redis | 0.081 Гб | 1,041 |
| ScyllaDB | 521 Тб + 27 Тб(денормализация) = 548 Тб | 11,976 |
| S3 | 35.2 Тб | 556.8 |

### Конфигурации серверов
| Название | Хостинг | Конфигурация | Cores | Cnt | Аренда |
| ---------------------- | -------------------------: | -------------------------: |  -------------------------: |  -------------------------: |  -------------------------: |
| Auth/User| own | i5-13500/64GB/2xNVMe512Gb/2x10Gb/s | 14 | 2 | 60 * 2 = 120$ |
| Server | own | i5-13500/64GB/2xNVMe512Gb/2x10Gb/s | 14 | 2 | 60 * 2 = 120$ |
| Channel | own | i5-13500/64GB/2xNVMe512Gb/2x10Gb/s | 14 | 2 | 60 * 2 = 120$ |
| Message | own | 2x6338/16x32GB/2xNVMe4T/2x25Gb/s | 64 | 7 | 241 * 7 = 1,687$|
| Attachment | own | 2x6338/16x32GB/2xNVMe4T/2x25Gb/s | 64 | 4 | 241 * 4 = 964$ |
| Call | own | 2x6338/16x32GB/2xNVMe4T/2x25Gb/s | 64 | 15 | 241 * 15 = 4,820$ |
| Итого ||||| 5421$ |
