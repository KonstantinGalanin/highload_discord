...
Для локальной балансировки трафика видеочата будем использовать L4 балансировку, так как WebRTC работает поверх UDP, и необходима минимальная задержка, а L7 балансировка анализирует содержимое пакетов, что будет создавать задержку.  
