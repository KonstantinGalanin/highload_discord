...
- Более 600 миллионов зарегистрированных пользователей [[10]](https://www.demandsage.com/discord-statistics/)
...
// _Всего сообщений в день / DAU = 850,000,000 / 29,000,000 = 29.3 сообщения в день_
...
_Рассчитывалось по [таблице](https://www.bankmycell.com/blog/number-of-discord-users/#section-1) с количеством зарегистрированных аккаунтов за каждый год_
...
- Сообщения: 29.3 _ 30.75 _ 2(байт) = 1,802 байт
- Картинки: 29.3 _ 4.57% _ 2(Мбайт) = 2,808,108 байт
- Файлы: 29.3 _ 0.08% _ 10(Мбайт) = 245,787 байт

Итого: 2.915 Мбайт / день = 1.04 Гбайт / год

Память на сообщения для всех пользователей:

- 850,000,000 _ (30.75 _ 2 + 4.57% _ 2(Мбайт) + 0.08% _ 10(Мбайт)) = 80.6 Тбайт / день = **28.73 Пбайт / год**
...
- Средний трафик звоноков в день: 4 (млрд мин) _ 60 _ 88 Кбит/с = 20,141,602 Гбит/день
- Средний трафик в секунду: 20,141,602 Гбит / (24 _ 60 _ 60) = 233.2 Гбит/с
...
- Общий трафик отправки сообщений в секнуду: 80.6 Тбайт/день / (24 _ 60 _ 60) = 7.64 Гбит/с
...
Пиковый трафик для сообщений = средний трафик для сообщений _ коэффициент запаса = 7.64 Гбит/с _ 3.08 Гбит/с = 23.53 Гбит/с
...
- Всего подписчиков = 19 млн _ 90% _ 7 + 19 млн _ 10% _ 100 = 309,700,000 подписчиков
- Кол-во запросов на подписку в секунду = 309,700,000 / ( 9(лет) _ 365 _ 24 _ 60 _ 60) = 1.1 запрос/секунду
