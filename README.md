...
<br>
<br>
&nbsp;&nbsp;&nbsp;&nbsp;В 2018 году DAU составлял 8.9 миллионов пользователей  
Допустим сейчас Пиковая нагрузка составляет:  
...
- Средний трафик звоноков в день: 4 (млрд мин) * 60 * 88 Кбит/с = 20,141,602 Гбит  
- Средний трафик в секунду: 20,141,602 Гбит / 24 * 60 * 60 = 233.2 Гбит/с  

#### Средний трафик отправки сообщений в секунду
- Общий трафик отправки сообщений в день = 80.6 Тбайт/день (из предыдущих вычислений)
