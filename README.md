...
![dc_map](./images/dc_map.jpg)


| ЦОД                     | Приблизительный трафик |
| -------------------------- | ----------------------: |
| Ванкувер        |                    7.5% |
| Чикаго           |                     7.5% |
| Нью-Йорк |                       7.5% |
...
### DNS балансировка  
Будем использовать Latency-based DNS, чтобы выдавать адрес ближайшего к пользователю ДЦ с минимальным RTT, так как для звонков необходимо наименьшее latency  
